...
(setf (gethash 'cairo-surface-t atdoc:*symbol-name-alias*) "CStruct"
 ...
 "@version{2020-12-16}
  ...
  surface as the target, using the function @fun{cairo-create}.

  There are different subtypes of a @sym{cairo-surface-t} structure for
  different drawing backends. For example, the function
  @fun{cairo-image-surface-create} creates a bitmap image in memory. The type
  of a surface can be queried with the function @fun{cairo-surface-type}.
...
(setf (gethash 'cairo-surface-type-t atdoc:*symbol-name-alias*) "CEnum"
 ...
 "@version{2020-12-16}
  ...
  the function @fun{cairo-surface-create-similar} as well.

  The surface type can be queried with the function @fun{cairo-surface-type}.
...
(defcenum cairo-surface-type-t
  ...
  @begin[code]{table}
    ...
    @entry[:subsurface]{The surface is a subsurface created with the function
      @fun{cairo-surface-create-for-rectangle}.}
...
(defcfun ("cairo_surface_create_similar" cairo-surface-create-similar)
 ...
 "@version{2020-12-16}
  ...
  the returned surface may be examined with the function
  @fun{cairo-surface-get-type}.

  Initially the surface contents are all 0; transparent if contents have
  transparency, black otherwise.

  Use the function @fun{cairo-surface-create-similar-image} if you need an
...
(defcfun ("cairo_surface_destroy" cairo-surface-destroy) :void
 ...
 "@version{2020-12-16}
  ...
  freed. See the function @fun{cairo-surface-reference}.
  @see-symbol{cairo-surface-t}
  @see-function{cairo-surface-reference}"
  (surface (:pointer (:struct cairo-surface-t))))
...
(defcfun ("cairo_surface_finish" cairo-surface-finish) :void
 #+cl-cffi-gtk-documentation
 "@version{2020-12-21}
  @argument[surface]{a @symbol{cairo-surface-t} instance}
  @begin{short}
  ...
  the drawable, which can be freed. After calling the function
  @fun{cairo-surface-finish} the only valid operations on a surface are getting
  ...
  trigger a @code{:surface-finished} error.

  When the last call to the function @fun{cairo-surface-destroy} decreases the
  reference count to zero, Cairo will call the function
  @fun{cairo-surface-finish} if it has not been called already, before freeing
  the resources associated with the surface.
  @see-symbol{cairo-surface-t}
  @see-function{cairo-surface-finish}
  @see-function{cairo-surface-destroy}"
  (surface (:pointer (:struct cairo-surface-t))))

(export 'cairo-surface-finish)
...
(defcfun ("cairo_surface_set_device_offset" cairo-surface-set-device-offset)
    :void
 #+cl-cffi-gtk-documentation
 "@version{2020-12-16}
  @argument[surface]{a @symbol{cairo-surface-t} instance}
...
(defcfun ("cairo_surface_get_reference_count" cairo-surface-get-reference-count)
 ...
 "@version{2020-12-16}
  @argument[surface]{a @symbol{cairo-surface-t} instance}
  @begin{return}
    The current reference count of @arg{surface}. If the instance is a nil
    instance, 0 will be returned.
  @end{return}
  @begin{short}
...
(defcfun ("cairo_surface_copy_page" cairo-surface-copy-page) :void
 #+cl-cffi-gtk-documentation
 "@version{2020-12-23}
  @argument[surface]{a @symbol{cairo-surface-t} instance}
  @begin{short}
    ...
    the next page.
  @end{short}
  Use the function @fun{cairo-surface-show-page} if you want to get an empty
  page after the emission.

  There is a convenience function for this that takes a @symbol{cairo_t}
  context, namely the function @fun{cairo-copy-page}.
  @see-symbol{cairo-surface-t}
  @see-symbol{cairo-t}
...
(export 'cairo-surface-copy-page)

;;; ----------------------------------------------------------------------------
;;; cairo_surface_show_page ()
;;; ----------------------------------------------------------------------------

(defcfun ("cairo_surface_show_page" cairo-surface-show-page) :void
 #+cl-cffi-gtk-documentation
 "@version{2020-12-23}
  @argument[surface]{a @symbol{cairo-surface-t} instance}
  @begin{short}
  ...
  There is a convenience function that takes a @symbol{cairo-t} context, namely
  the function @fun{cairo-show-page}.
  @see-symbol{cairo-surface-t}
  @see-function{cairo-surface-copy-page}
  @see-function{cairo-show-page}"
  (surface (:pointer (:struct cairo-surface-t))))

(export 'cairo-surface-show-page)
