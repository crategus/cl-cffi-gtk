...
(setf (gethash 'cairo-t atdoc:*symbol-name-alias*) "Type")
(setf (gethash 'cairo-t atdoc:*external-symbols*)
 "@version{2012-12-21}
  @begin{short}
  ...
  @em{Cairo} contexts, as @sym{cairo-t} objects are named, are central to
  @em{cairo} and all drawing with @em{cairo} is always done to a @sym{cairo-t}
  object.
...
(setf (documentation 'cairo-create 'function)
 "@version{2012-12-21}
...
(setf (documentation 'cairo-destroy 'function)
 "@version{2012-12-21}
...
(setf (documentation 'cairo-set-source-rgb 'function)
 "@version{2012-12-21}
...
(setf (documentation 'cairo-set-source-surface 'function)
 "@version{2012-12-21}
  @argument[cr]{a cairo context}
...
(setf (documentation 'cairo-fill 'function)
 "@version{2012-12-21}
  @argument[cr]{a cairo context}
  @begin{short}
...
(setf (documentation 'cairo-paint 'function)
 "@version{2012-12-21}
  @argument[cr]{a cairo context}
  @begin{short}
