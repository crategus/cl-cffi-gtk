...
(defcfun ("g_option_context_new" g-option-context-new)
 ...
 "@version{2013-3-7}
  ...
  @begin{return}
    ...
    @fun{g-option-context-free} after use.
  @end{return}
  ...
  @fun{g-option-context-set-translate-func}, so it should normally be passed
  untranslated.
...
;;;
;;; summary :
;;;     a string to be shown in --help output before the list of options, or NULL. [allow-none]
;;;
;;; Since 2.12
;;; ----------------------------------------------------------------------------
...
;;;
;;; description :
;;;     a string to be shown in --help output after the list of options, or NULL. [allow-none]
;;;
;;; Since 2.12
;;; ----------------------------------------------------------------------------
...
;;;
;;; argc :
;;;     a pointer to the number of command line arguments. [inout][allow-none]
;;;
;;; argv :
;;;     a pointer to the array of command line arguments. [inout][array length=argc][allow-none]
;;;
;;; error :
...
;;;
;;; group :
;;;     the GOptionGroup to create help for, or NULL. [allow-none]
;;;
;;; Returns :
...
;;;
;;; user_data :
;;;     user data that will be passed to the pre- and post-parse hooks, the error hook and to callbacks of G_OPTION_ARG_CALLBACK options, or NULL. [allow-none]
;;;
;;; destroy :
;;;     a function that will be called to free user_data, or NULL. [allow-none]
;;;
;;; Returns :
...
;;;
;;; pre_parse_func :
;;;     a function to call before parsing, or NULL. [allow-none]
;;;
;;; post_parse_func :
;;;     a function to call after parsing, or NULL. [allow-none]
;;;
;;; Since 2.6
;;; GOptionErrorFunc ()
;;;
