...
(defcfun ("gdk_window_create_similar_surface" gdk-window-create-similar-surface)
 ...
 "@version{*2021-5-13}
  ...
  type of the returned surface may be examined with the function
...
(defcfun ("gdk_cairo_create" gdk-cairo-create)  (:pointer (:struct cairo-t))
 ...
 "@version{2020-12-29}
  ...
  @begin{return}
    A newly created @symbol{cairo-t} context. Free with the function
    @fun{cairo-destroy} when you are done drawing.
  @end{return}
  @begin{short}
  ...
  @sym{cairo-t} instance will produce undefined results, so avoid it at all
  costs.
  ...
  @code{:expose} event you should use the functions
  ...
  @begin[Warning]{dictionary}
    The function @sym{gdk-cairo-create} has been deprecated since version 3.22
    and should not be used in newly-written code. Use the functions
    @fun{gdk-window-begin-draw-frame} and
    @fun{gdk-drawing-context-cairo-context} instead.
  @end{dictionary}
  @see-class{gdk-window}
  @see-symbol{cairo-t}
...
(defun gdk-cairo-clip-rectangle (cr)
 ...
 "@version{2020-12-29}
  ...
  @begin{return}
    A @class{gdk-rectangle} object with the clip or @em{false} if all of
    @arg{cr} is clipped and all drawing can be skipped.
  @end{return}
  @begin{short}
    This is a convenience function around the function @fun{cairo-clip-extents}.
  @end{short}
...
(defcfun ("gdk_cairo_set_source_color" gdk-cairo-set-source-color) :void
 ...
 "@version{2020-12-29}
  ...
  @end{short}
  @begin[Warning]{dictionary}
    The function @sym{gdk-cairo-set-source-color} has been deprecated since
    version 3.4 and should not be used in newly-written code. Use the function
    @fun{gdk-cairo-set-source-rgba} instead.
  @end{dictionary}
  @see-symbol{cairo-t}
  @see-class{gdk-color}
...
(defcfun ("gdk_cairo_set_source_pixbuf" gdk-cairo-set-source-pixbuf) :void
 ...
 "@version{2020-12-30}
  ...
  The pattern has an extend mode of @code{:none} and is aligned so
  that the origin of pixbuf is (@arg{x}, @arg{y}).
  @see-symbol{cairo-t}
...
(defcfun ("gdk_cairo_set_source_window" gdk-cairo-set-source-window) :void
 ...
 "@version{2020-12-29}
  ...
  The pattern has an extend mode of @code{:none} and is aligned so that the
  origin of @arg{window} is (@arg{x}, @arg{y}). The window contains all its
...
(defcfun ("gdk_cairo_region_create_from_surface"
 ...
 "@version{2020-12-30}
  ...
  @begin{return}
    A @symbol{cairo.region-t} instance, must be freed with the function
    @fun{cairo-region-destroy}.
  @end{return}
  @begin{short}
  ...
  the function @fun{cairo-surface-set-device-offset}.
  @see-symbol{cairo-surface-t}
  @see-symbol{cairo-region-t}
...
(defcfun ("gdk_cairo_surface_create_from_pixbuf"
 ...
 "@version{2020-12-30}
  ...
  @argument[scale]{an integer with the scale of the new surface, or 0 to use
    same as @arg{window}}
  @argument[for-window]{the @class{gdk-window} object this will be drawn to,
    or @code{nil}}
  @begin{return}
    A new Cairo surface, must be freed with the function
    @fun{cairo-surface-destroy}.
  @end{return}
  @begin{short}
...
(defcfun ("gdk_cairo_draw_from_gl" gdk-cairo-draw-from-gl) :void
 ...
 "@version{2020-12-30}
  @argument[cr]{a @symbol{cairo-t} context}
  @argument[window]{the @class{gdk-window} object we are rendering for,
    not necessarily into}
  @argument[source]{an integer with the GL ID of the source buffer}
  @argument[source-type]{an integer with the type of the source}
  @argument[buffer-scale]{an integer with the scale-factor that the source
  ...
  @end{short}
  It takes a render buffer ID (@arg{source-type} == @code{GL_RENDERBUFFER}) or
  a texture ID (@arg{source-type} == @code{GL_TEXTURE}) and draws it onto
  @arg{cr} with an @code{OVER} operation, respecting the current clip. The top
  left corner of the rectangle specified by @arg{x}, @arg{y}, @arg{width} and
  @arg{height} will be drawn at the current (0,0) position of the
  Cairo context.
