...
;;;     g-type-children
;;;     g-type-interfaces
;;;     g-type-interface_prerequisites
;;;
;;;     g_type_set_qdata
;;;     g_type_get_qdata
;;;     g_type_query
...
;; gtype is a Lisp representations of GType
...
;;; G_TYPE_FROM_INTERFACE()
;;;
;;; #define G_TYPE_FROM_INTERFACE(interface)
;;;         (((GTypeInterface*) (interface))->g_type)
;;;
...
;;;
;;; Returns :
;;;     The nextmost fundamental type ID to be registered, or 0 if the
