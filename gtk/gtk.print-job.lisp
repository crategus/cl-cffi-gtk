...
;;;     gtk_print_job_set_source_fd                        not implemented
...
(defcallback gtk-print-job-complete-func :void
    ((job (g-object gtk-print-job))
     (data :pointer)
     (err :pointer))
...
#+cl-cffi-gtk-documentation
(setf (gethash 'gtk-print-job-complete-func atdoc:*symbol-name-alias*)
      "Callback"
      (gethash 'gtk-print-job-complete-func atdoc:*external-symbols*)
 "@version{2021-12-25}
  @begin{short}
...
(export 'gtk-print-job-complete-func)
