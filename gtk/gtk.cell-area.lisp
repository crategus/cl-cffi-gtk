...
;;; Properties
;;;
;;;   "edit-widget"              GtkCellEditable*      : Read
;;;   "edited-cell"              GtkCellRenderer*      : Read
;;;   "focus-cell"               GtkCellRenderer*      : Read / Write
;;;
;;; Signals
;;;
...
;;; Description
;;;
;;; The GtkCellArea is an abstract class for GtkCellLayout widgets (also
;;; referred to as "layouting widgets") to interface with an arbitrary number of
;;; GtkCellRenderers and interact with the user for a given GtkTreeModel row.
;;;
...
;;;
;;; cell_area :
;;;     the GtkWidget relative GdkRectangle coordinates where editable should be
;;;     added
;;;
;;; path :
...
;;;                     gpointer         user_data)      : Run First
;;;
;;; Indicates that focus changed on this area. This signal is emitted either as
;;; a result of focus handling or event handling.
;;;
