...
(setf (documentation 'gtk-ui-manager 'type)
 "@version{2021-5-30}
  ...
  @begin[GtkUIManager as GtkBuildable]{dictionary}
    ...
    @sym{gtk-ui-manager} can be embedded in other parts of the constructed user
    interface with the help of the @code{constructor} attribute. See the example
    below.
...
(setf (gethash 'gtk-ui-manager-add-tearoffs atdoc:*function-name-alias*)
 ...
 "@version{2021-5-30}
  ...
  menus generated by the @class{gtk-ui-manager} object will have tearoff menu
  items. The slot access function @sym{(setf gtk-ui-manager-add-tearoffs)} sets
  the @slot[gtk-ui-manager]{add-tearoffs} property.
...
(defcfun ("gtk_ui_manager_insert_action_group"
 ...
 "@version{2021-5-30}
  ...
  @argument[group]{the @class{gtk-action-group} object to be inserted}
...
(defcfun ("gtk_ui_manager_add_ui" gtk-ui-manager-add-ui) :void
 ...
 "@version{2021-5-30}
  @argument[manager]{a @class{gtk-ui-manager} object}
  @argument[id]{an unigned integer with the merge ID for the merged UI, see the
    function @fun{gtk-ui-manager-new-merge-id}}
  @argument[path]{a string with a path}
