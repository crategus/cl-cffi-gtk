...
(defun (setf gtk-text-iter-offset) (char-offset iter)
  (foreign-funcall "gtk_text_iter_set_offset"
                   (g-boxed-foreign gtk-text-iter) iter :int char-offset :void)
  char-offset)
...
(defcfun ("gtk_text_iter_get_offset" gtk-text-iter-offset) :int
 ...
 "@version{2020-3-12}
  ...
  @argument[iter]{a @class{gtk-text-iter} iterator}
  @argument[char-offset]{a @code{:int} with a character number}
  @begin{short}
    Accessor for the character offset of a @class{gtk-text-iter} iterator.
  @end{short}
...
(defun (setf gtk-text-iter-line) (line-number iter)
  (foreign-funcall "gtk_text_iter_set_line"
                   (g-boxed-foreign gtk-text-iter) iter :int line-number :void)
  line-number)
...
(defcfun ("gtk_text_iter_get_line" gtk-text-iter-line) :int
 ...
 "@version{2020-3-13}
  ...
  @argument[iter]{a @class{gtk-text-iter} iterator}
  @argument[line-number]{a @code{:int} with the line number, counted from 0}
  @begin{short}
    Accessor for the line number containing the iterator.
  @end{short}
  ...
  Lines in a text buffer are numbered beginning with 0 for the first line in the
  buffer. If the line number is negative or larger than the number of lines in
  the buffer, moves the iterator to the start of the last line in the buffer.
  @see-class{gtk-text-iter}
  @see-class{gtk-text-buffer}"
  (iter (g-boxed-foreign gtk-text-iter)))
...
(defun (setf gtk-text-iter-line-offset) (char-on-line iter)
  (foreign-funcall "gtk_text_iter_set_line_offset"
                   (g-boxed-foreign gtk-text-iter) iter :int char-on-line :void)
  char-on-line)
...
(defcfun ("gtk_text_iter_get_line_offset" gtk-text-iter-line-offset) :int
 ...
 "@version{2020-3-13}
  ...
  @argument[iter]{a @class{gtk-text-iter} iterator}
  @argument[char-on-line]{a @code{:int} with a character offset relative to the
    start of the iterators current line}
  @begin{short}
    Accessor for the character offset relative to the start of the current line
    of the iterator.
  @end{short}
  ...
  line, to a new character (not byte) offset.
...
(defun (setf gtk-text-iter-line-index) (byte-on-line iter)
  (foreign-funcall "gtk_text_iter_set_line_index"
                   (g-boxed-foreign gtk-text-iter) iter :int byte-on-line :void)
  byte-on-line)
...
(defcfun ("gtk_text_iter_get_line_index" gtk-text-iter-line-index) :int
 ...
 "@version{2020-3-13}
  ...
  @argument[iter]{a @class{gtk-text-iter} iterator}
  @argument[byte-on-line]{a @code{:int} with a byte index relative to the start
    of current line of the iterator}
  @begin{short}
    Accessor for the byte offset relative to the start of the current line
    of the iterator.
  @end{short}
  ...
  @sym{(setf gtk-text-iter-line-index)} sets the byte index of the iterator.
...
(defcfun ("gtk_text_iter_get_visible_line_index"
 ...
 "@version{2020-3-13}
  ...
  @argument[iter]{a @class{gtk-text-iter} iterator}
  @argument[byte-on-line]{a @code{:int} with a byte index}
  @begin{short}
    Accessor for the byte index relative to the start of the current line
    of the iterator.
  @end{short}
...
(defcfun ("gtk_text_iter_get_visible_line_offset"
 ...
 "@version{2020-3-13}
  ...
  @argument[iter]{a @class{gtk-text-iter} iterator}
  @argument[char-on-line]{a @code{:int} with a character offset}
  @begin{short}
    Accessor for the character offset relative to the start of the current line
    of the iterator.
  @end{short}
...
(defcfun ("gtk_text_iter_get_char" gtk-text-iter-char) unichar
 ...
 "@version{2020-3-13}
  ...
  Returns a Unicode character, or 0 if the iterator is not dereferenceable.
  @see-class{gtk-text-iter}"
  (iter (g-boxed-foreign gtk-text-iter)))
...
(defcfun ("gtk_text_iter_get_slice" gtk-text-iter-slice)
 ...
 #+cl-cffi-gtk-documentation
 "@version{2020-3-13}
  @argument[start]{a @class{gtk-text-iter} iterator with the start of a range}
  @argument[end]{a @class{gtk-text-iter} iterator with the end of a range}
  @return{A string with a slice of text from the buffer.}
  @begin{short}
...
(defcfun ("gtk_text_iter_get_text" gtk-text-iter-text)
 ...
 "@version{2020-3-13}
  @argument[start]{a @class{gtk-text-iter} iterator with the start of a range}
  @argument[end]{a @class{gtk-text-iter} iterator with the end of a range}
  @return{A string with characters from the buffer.}
  @begin{short}
    Returns a string with the text in the given range.
  @end{short}
...
(defcfun ("gtk_text_iter_starts_tag" gtk-text-iter-starts-tag) :boolean
 ...
 "@version{2020-3-13}
  ...
  @end{short}
  If the tag is @code{nil}, returns @em{true} if any tag is toggled on at this
  point.
  ...
  @fun{gtk-text-iter-has-tag} will also return @em{true} for the same parameters.
...
(defcfun ("gtk_text_iter_editable" gtk-text-iter-editable) :boolean
 ...
 "@version{2020-3-13}
  ...
  the function @fun{gtk-text-iter-attributes}. If no tags applied to this
...
(defcfun ("gtk_text_iter_get_chars_in_line" gtk-text-iter-chars-in-line) :int
 ...
 "@version{2020-3-13}
  @argument[iter]{a @class{gtk-text-iter} iterator}
  @return{A @code{:int} with the number of characters in the line.}
  @begin{short}
...
(defcfun ("gtk_text_iter_get_bytes_in_line" gtk-text-iter-bytes-in-line) :int
 ...
 "@version{2020-3-13}
  @argument[iter]{a @class{gtk-text-iter} iterator}
  @return{A @code{:int} with the number of bytes in the line.}
  @begin{short}
...
(defcfun ("gtk_text_iter_get_language" gtk-text-iter-language)
 ...
 "@version{2020-3-13}
  @argument[iter]{a @class{gtk-text-iter} iterator}
  @return{A @class{pange-language} structure with the language in effect at
    the iterator.}
  @begin{short}
...
(defun gtk-text-iter-move (iter &key (count 1) (by :char) (direction :forward))
 ...
 "@version{2020-1-24}
  @begin{short}
    This is a convenience function of the Lisp implementation.
  @end{short}
  The function @sym{gtk-text-iter-move} combines the following functions in a
  single function:
  @begin{itemize}
...
(defcfun ("gtk_text_iter_forward_char" gtk-text-iter-forward-char) :boolean
 ...
 "@version{2020-3-13}
  ...
  instead of a character, if you have images in your buffer. If the iterator is
  the end iterator or one character before it, the iterator will now point at
  the end iterator, and the function @sym{gtk-text-iter-forward-char} returns
...
(defcfun ("gtk_text_iter_backward_char" gtk-text-iter-backward-char) :boolean
 ...
 "@version{2020-3-13}
  ...
  the buffer, character offset 0, the function @sym{gtk-text-iter-backward-char}
...
(defcfun ("gtk_text_iter_forward_chars" gtk-text-iter-forward-chars) :boolean
 ...
 "@version{2020-3-13}
  @argument[iter]{a @class{gtk-text-iter} iterator}
  @argument[count]{a @code{:int} with the number of characters to move, may be
    negative}
  ...
  in the buffer is not dereferenceable. If @arg{count} is 0, the function does
  nothing and returns @code{nil}.
  @see-class{gtk-text-iter}
...
(defcfun ("gtk_text_iter_forward_line" gtk-text-iter-forward-line) :boolean
 ...
 "@version{2020-3-14}
  ...
  If the the iterator is already on the last line of the buffer, moves the
  iterator to the end of the current line. If after the operation, the
  iterator is at the end of the buffer and not dereferencable, returns
...
(defcfun ("gtk_text_iter_forward_word_ends" gtk-text-iter-forward-word-ends)
 ...
 "@version{2020-3-14}
  @argument[iter]{a @class{gtk-text-iter} iterator}
  @argument[count]{a @code{:int} with the number of times to move}
...
(defcfun ("gtk_text_iter_forward_cursor_positions"
 ...
 "@version{2020-3-14}
  @argument[iter]{a @class{gtk-text-iter} iterator}
  @argument[count]{a @code{:int} with the number of positions to move}
  @return{@em{True} if we moved and the new position is dereferenceable.}
  @begin{short}
...
(defcfun ("gtk_text_iter_backward_sentence_starts"
 ...
 "@version{2020-3-14}
  @argument[iter]{a @class{gtk-text-iter} iterator}
  @argument[count]{a @code{:int} with the number of sentences to move}
  @return{@em{True} if the iterator moved and is not the end iterator.}
  @begin{short}
...
(defcfun ("gtk_text_iter_forward_visible_line"
 ...
 "@version{2020-3-14}
  ...
  @end{short}
  Returns @em{true} if there was a next line to move to, and @code{nil} if the
  iterator was simply moved to the end of the buffer and is now not
  dereferenceable, or if the iterator was already at the end of the buffer.
  @see-class{gtk-text-iter}
...
(defcfun ("gtk_text_iter_forward_to_line_end" gtk-text-iter-forward-to-line-end)
 ...
 "@version{2020-3-14}
  ...
  last line in the buffer, which does not end in paragraph delimiters, moves to
  the end iterator (end of the last line), and returns @code{nil}.
  @see-class{gtk-text-iter}"
  (iter (g-boxed-foreign gtk-text-iter)))
...
(defun gtk-text-iter-forward-search (iter str flags limit)
 ...
 "@version{2020-3-14}
  ...
  O(n) operation, so you may wish to use @arg{limit} to avoid locking up your UI
  on large buffers.
...
(defun gtk-text-iter-backward-search (iter str flags limit)
 #+cl-cffi-gtk-documentation
 "@version{2020-3-14}
  @argument[iter]{a @class{gtk-text-iter} iterator where the search begins}
...
(defun gtk-text-iter-search (iter str &key flags limit (direction :forward))
 ...
 "@version{2020-3-14}
  ...
  @argument[flags]{flags of type @symbol{gtk-text-search-flags} affecting how
    the search is done}
  @argument[limit]{a @class{gtk-text-iter} with the bound for the search, or
    @code{nil} for the end of the buffer}
  @argument[direction]{the value @code{:forward} indicates forward search and
    the value @code{:backward} backward search}
  @begin{return}
    @code{search-p} -- a @code{:boolean} whether a match was found. @br{}
...
(defcfun ("gtk_text_iter_equal" gtk-text-iter-equal) :boolean
 #+cl-cffi-gtk-documentation
 "@version{2020-3-14}
  @argument[lhs]{a @class{gtk-text-iter} iterator}
  @argument[rhs]{another @class{gtk-text-iter} iterator}
...
(defcfun ("gtk_text_iter_in_range" gtk-text-iter-in-range) :boolean
 ...
 "@version{2020-3-14}
  @argument[iter]{a @class{gtk-text-iter} iterator}
  @argument[start]{a @class{gtk-text-iter} with the start of range}
  @argument[end]{a @class{gtk-text-iter} with the end of range}
...
(defcfun ("gtk_text_iter_order" gtk-text-iter-order) :void
 #+cl-cffi-gtk-documentation
 "@version{2020-3-14}
  @argument[first]{a @class{gtk-text-iter} iterator}
  @argument[second]{another @class{gtk-text-iter} iterator}
  @begin{short}
