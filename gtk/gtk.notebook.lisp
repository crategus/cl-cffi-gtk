...
(setf (gethash 'gtk-notebook-group-name atdoc:*function-name-alias*)
 ...
 "@version{2021-12-17}
  ...
  The @sym{gtk-notebook-group-name} slot access function gets the current group
  name for the notebook. The @sym{(setf gtk-notebook-group-name)} slot access
  function sets a group name.
...
(setf (gethash 'gtk-notebook-scrollable atdoc:*function-name-alias*)
 ...
 "@version{2021-12-17}
  ...
  The @sym{gtk-notebook-scrollable} slot access function returns whether the
  tab label area has arrows for scrolling if there are too many tabs to fit in
  the area. The @sym{(setf gtk-notebook-scrollable)} slot access function sets
...
(setf (gethash 'gtk-notebook-show-border atdoc:*function-name-alias*)
 ...
 "@version{2021-12-17}
  ...
  The @sym{gtk-notebook-show-border} slot access function returns whether a
  bevel will be drawn around the notebook pages. The
  @sym{(setf gtk-notebook-show-border)} slot access function sets whether a
  bevel will be drawn.
...
(setf (gethash 'gtk-notebook-show-tabs atdoc:*function-name-alias*)
 ...
 "@version{2021-12-17}
  ...
  The @sym{gtk-notebook-show-tabs} slot access function returns whether the
  tabs of the notebook are shown. The @sym{(setf gtk-notebook-show-tabs)} slot
  access function sets whether to show the tabs.
  @see-class{gtk-notebook}")
...
(setf (gethash 'gtk-notebook-tab-pos atdoc:*function-name-alias*)
 ...
 "@version{2021-12-17}
  ...
  The @sym{gtk-notebook-tab-pos} slot access function gets the edge at which
  the tabs for switching pages in the notebook are drawn. The
  @sym{(setf gtk-notebook-tab-pos)} slot access function sets the edge.
  @see-class{gtk-notebook}
...
(defun gtk-notebook-add-page (notebook child tab &key (position :end) menu)
 #+cl-cffi-gtk-documentation
 "@version{2021-12-17}
  @argument[notebook]{a @class{gtk-notebook} widget}
      ...
      (if menu
          (gtk-notebook-append-page-menu notebook
                                         ...
                                         (if (eq menu :default)
                                             (null-pointer)
                                             menu))
          (gtk-notebook-append-page notebook child tab)))
    (:start
     (if menu
         (gtk-notebook-prepend-page-menu notebook
                                         ...
                                         (if (eq menu :default)
                                             (null-pointer)
                                             menu))
         (gtk-notebook-prepend-page notebook child tab)))
    (otherwise
     (if menu
...
(defun (setf gtk-notebook-current-page) (num notebook)
...
(defun (setf gtk-notebook-menu-label) (value notebook child)
  (foreign-funcall "gtk_notebook_set_menu_label"
                   (g-object gtk-notebook) notebook
                   (g-object gtk-widget) child
                   (g-object gtk-widget) value
                   :void)
  value)
...
(defun (setf gtk-notebook-tab-label) (value notebook child)
...
(defun (setf gtk-notebook-menu-label-text) (value notebook child)
  (setf (gtk-notebook-child-menu-label notebook child) value))
...
(defun (setf gtk-notebook-tab-label-text) (value notebook child)
  (setf (gtk-notebook-child-tab-label notebook child) value))
...
(defun gtk-notebook-tab-reorderable (notebook child)
 ...
 "@version{2021-12-17}
  ...
  @begin[Note]{dictionary}
    ...
    @fun{gtk-notebook-child-reorderable} child accessor function.
  @end{dictionary}
  @see-class{gtk-notebook}
  @see-class{gtk-widget}
...
(defun (setf gtk-notebook-tab-detachable) (value notebook child)
  (setf (gtk-notebook-child-detachable notebook child) value))
...
(defun (setf gtk-notebook-action-widget) (value notebook pack-type)
