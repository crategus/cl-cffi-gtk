...
(setf (gethash 'gtk-selection-data-selection atdoc:*function-name-alias*) "Accessor")
(setf (documentation 'gtk-selection-data-selection 'function)
 "@version{2012-12-23}
  @begin{short}
...
(setf (gethash 'gtk-selection-data-target atdoc:*function-name-alias*) "Accessor")
(setf (documentation 'gtk-selection-data-target 'function)
 "@version{2012-12-23}
  @begin{short}
...
(setf (gethash 'gtk-selection-data-type atdoc:*function-name-alias*) "Accessor")
(setf (documentation 'gtk-selection-data-type 'function)
 "@version{2012-12-23}
  @begin{short}
...
(setf (gethash 'gtk-selection-data-format atdoc:*function-name-alias*) "Accessor")
(setf (documentation 'gtk-selection-data-format 'function)
 "@version{2012-12-23}
  @begin{short}
...
(setf (gethash 'gtk-selection-data-data atdoc:*function-name-alias*) "Accessor")
(setf (documentation 'gtk-selection-data-data 'function)
 "@version{2012-12-23}
  @begin{short}
...
(setf (gethash 'gtk-selection-data-length atdoc:*function-name-alias*) "Accessor")
(setf (documentation 'gtk-selection-data-length 'function)
 "@version{2012-12-23}
  @begin{short}
...
(setf (gethash 'gtk-selection-data-display atdoc:*function-name-alias*) "Accessor")
(setf (documentation 'gtk-selection-data-display 'function)
 "@version{2012-12-23}
  @begin{short}
...
(setf (documentation 'make-gtk-selection-data 'function)
 "@version{2012-12-23}
  @short{Returns an object of type @class{gtk-selection-data}}")

(setf (documentation 'copy-gtk-selection-data 'function)
 "@version{2012-12-23}
  @short{Copies an object of type @class{gtk-selection-data}}")
...
(define-g-boxed-cstruct gtk-target-entry \"GtkTargetEntry\"
  ...
  @end{pre}
  @begin{table}
    @entry[gchar *target]{a string representation of the target type}
    @entry[guint flags]{@symol{gtk-target-flags} for DND}
    @entry[guint info]{an application-assigned integer ID which will get passed
      as a parater to e. g the \"selection-get\" signal. It allows the
...
(setf (documentation 'gtk-target-entry-target 'function)
 "@version{2012-12-23}
  @begin{short}
    Accessor for the slot @code{target} of the @class{gtk-target-entry}
    structure.
  @end{short}
  @see-class{gtk-target-entry}")

(setf (gethash 'gtk-target-entry-flags atdoc:*function-name-alias*) "Accessor")
(setf (documentation 'gtk-target-entry-flags 'function)
 "@version{2012-12-23}
  @begin{short}
    Accessor for the slot @code{flags} of the @class{gtk-target-entry}
    structure.
  @end{short}
  @see-class{gtk-target-entry}")

(setf (gethash 'gtk-target-entry-info atdoc:*function-name-alias*) "Accessor")
(setf (documentation 'gtk-target-entry-info 'function)
 "@version{2012-12-23}
  @begin{short}
    Accessor for the slot @code{info} of the @class{gtk-target-entry}
    structure.
  @end{short}
  @see-class{gtk-target-entry}")
...
(setf (documentation 'make-gtk-target-entry 'function)
 "@version{2012-12-23}
  @short{Returns an object of type @class{gtk-target-entry}}")
...
;;; --- End of file atdoc-gtk.selections.lisp ----------------------------------
