...
(defcfun ("gtk_image_menu_item_new_from_stock"
 ...
 "@version{2020-2-16}
  ...
  @code{nil} for @arg{accel-group}. Next call the function
  @fun{gtk-menu-item-accel-path} with an appropriate path for the menu item, use
  the function @fun{gtk-stock-lookup} to look up the standard accelerator for
  the stock item, and if one is found, call the function
  @fun{gtk-accel-map-add-entry} function to register it.
  @begin[Warning]{dictionary}
...
(defcfun ("gtk_image_menu_item_new_with_label"
 ...
 "@version{2020-2-16}
  @argument[label]{a @code{:string} with the text of the menu item}
  @return{A new @class{gtk-image-menu-item} widget.}
  @begin{short}
...
(defcfun ("gtk_image_menu_item_new_with_mnemonic"
 ...
 "@version{2020-2-16}
  @argument[label]{a @code{:string} with the text of the menu item, with an
