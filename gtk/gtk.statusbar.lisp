...
(setf (documentation 'gtk-statusbar 'type)
 "@version{2020-4-19}
  ...
  generated by the function @fun{gtk-statusbar-context-id}, given a message
...
(defun gtk-statusbar-push (statusbar context-id text)
 ...
 "@version{2020-4-19}
  ...
  @argument[context-id]{the message's context ID, as returned by the function
    @fun{gtk-statusbar-context-id}}
  @argument[text]{a string with the message to add to the @arg{statusbar}}
