...
(setf (documentation 'gtk-print-operation 'type)
 ...
 lambda (operation context)    : Run Last
      ...
      the @fun{gtk-print-operation-n-pages} function.
      @begin[code]{table}
 ...
 lambda (operation context page-nr)    : Run Last
   ...
   @}
      @end{pre}
      Use the @fun{gtk-print-operation-use-full-page} and
 ...
 lambda (operation context)    : Run Last
      ...
      @fun{gtk-print-operation-n-pages} function, and return @em{true} if
 ...
 lambda (operation context page-nr setup)    : Run Last
      ...
      @begin[code]{table}
        ...
        @entry[context]{The @class{gtk-print-context} object for the current
          operation.}
        @entry[page-nr]{The 0-based number of the currently printed page.}
        @entry[setup]{The @sym{gtk-page-setup} object.}
      @end{table}
 ...
 lambda (operation)    : Run Last
      ...
      discriminated. Use the @fun{gtk-print-operation-get-status} function to
 ...
 lambda (preview context page-setup)    : Run Last
      ...
      cairo context, using the @fun{gtk-print-context-set-cairo-context}
      function.
      @begin[code]{table}
        ...
        @entry[page-setup]{The @sym{gtk-page-setup} object for the current
          page.}
      @end{table}
...
(setf (gethash 'gtk-print-operation-allow-async atdoc:*function-name-alias*)
 ...
 "@version{2013-11-15}
  ...
  The @sym{(setf gtk-print-operation-allow-async)} slot access function
  sets whether the @fun{gtk-print-operation-run} function may return before
...
(setf (gethash 'gtk-print-operation-current-page atdoc:*function-name-alias*)
 ...
 "@version{2013-11-15}
  ...
  The @sym{(setf gtk-print-operation-current-page)} slot access function
...
(setf (gethash 'gtk-print-operation-custom-tab-label
 ...
 "@version{2013-11-15}
  ...
  The @sym{(setf gtk-print-operation-custom-tab-label)} slot access function
...
(setf (documentation (atdoc:get-slot-from-name "default-page-setup"
 ...
 "The @code{default-page-setup} property of type @class{gtk-page-setup}
  (Read / Write) @br{}
  The @class{gtk-page-setup} used by default. This page setup will be used by
  the @fun{gtk-print-operation-run} function, but it can be overridden on a
...
(setf (gethash 'gtk-print-operation-default-page-setup
 ...
 "@version{2013-11-15}
  @syntax[]{(gtk-print-operation-default-page-setup object) => default-page-setup}
  @syntax[]{(setf (gtk-print-operation-default-page-setup object) default-page-setup)}
  @argument[object]{a @class{gtk-print-operation} object}
  ...
  The @sym{gtk-print-operation-default-page-setup} slot access function
  returns the default page setup.

  The @sym{(setf gtk-print-operation-current-page)} slot access function
  makes @arg{default-page-setup} the default page setup for the print
  operation.
...
(setf (gethash 'gtk-print-operation-embed-page-setup
 ...
 "@version{2013-11-15}
  ...
  The @sym{gtk-print-operation-embed-page-setup} slot access function
  returns whether page setup selection combos are embedded.

  The @sym{(setf gtk-print-operation-embed-page-setup)} slot access function
...
(setf (gethash 'gtk-print-operation-export-filename atdoc:*function-name-alias*)
 ...
 "@version{2013-11-15}
  ...
  The @sym{(setf gtk-print-operation-export-filename)} slot access function
...
(setf (gethash 'gtk-print-operation-has-selection atdoc:*function-name-alias*)
 ...
 "@version{2013-11-15}
  ...
  The @sym{gtk-print-operation-has-selection} slot access function
  returns Whether there is a selection.

  The @sym{(setf gtk-print-operation-has-selection)} slot access function
  sets whether there is a selection to print.

  Application has to set number of pages to which the selection will draw by
  the @fun{gtk-print-operation-n-pages} function in a callback of the
  \"begin-print\" signal.
  @see-class{gtk-print-operation}")
...
(setf (gethash 'gtk-print-operation-job-name atdoc:*function-name-alias*)
 ...
 "@version{2013-11-15}
  ...
  The @sym{(setf gtk-print-operation-job-name)} slot access function
...
(setf (documentation (atdoc:get-slot-from-name "print-settings"
 ...
 "The @code{print-settings} property of type @symbol{gtk-print-settings}
  (Read / Write) @br{}
  The @sym{gtk-print-settings} object used for initializing the dialog. Setting
  this property is typically used to re-establish print settings from a previous
  print operation, see the @fun{gtk-print-operation-run} function.")
...
(setf (gethash 'gtk-print-operation-print-settings atdoc:*function-name-alias*)
 ...
 "@version{2013-11-15}
  @syntax[]{(gtk-print-operation-print-settings object) => print-settings}
  @syntax[]{(setf (gtk-print-operation-print-settings object) print-settings)}
  @argument[object]{a @class{gtk-print-operation} object}
  ...
  The @sym{gtk-print-operation-print-settings} slot access function
  ...
  The @sym{(setf gtk-print-operation-print-settings)} slot access function
...
(setf (gethash 'gtk-print-operation-status atdoc:*function-name-alias*)
 ...
 "@version{2013-11-15}
  ...
  @argument[object]{a @class{gtk-print-operation} object}
  @argument[status]{the status of the print operation}
  @begin{short}
    Accessor of the @slot[gtk-print-operation]{status} slot of the
    @class{gtk-print-operation} class.
  @end{short}

  The @sym{gtk-print-operation-status} slot access function
...
(setf (gethash 'gtk-print-operation-status-string atdoc:*function-name-alias*)
 ...
 "@version{2013-11-15}
  ...
  The @sym{gtk-print-operation-status-string} slot access function
...
(setf (gethash 'gtk-print-operation-support-selection
 ...
 "@version{2013-11-15}
  ...
  The @sym{gtk-print-operation-support-selection} slot access function
  returns whether the application supports print of selection.

  The @sym{(setf gtk-print-operation-support-selection)} slot access function
...
(setf (gethash 'gtk-print-operation-use-full-page atdoc:*function-name-alias*)
 ...
 "@version{2013-11-15}
  @syntax[]{(setf (gtk-print-operation-unit object) full-page)}
  @argument[object]{a @class{gtk-print-operation} object}
