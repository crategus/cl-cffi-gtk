...
;;; GtkPrintOperation, the main one being "draw-page", which you are supposed to
;;; catch and render the page on the provided GtkPrintContext using Cairo.
;;;
...
;;;                     gpointer                  user_data)      : Run Last
;;;
;;; The ::ready signal gets emitted once per preview operation, before the first
;;; page is rendered.
;;;
...
;;; } GtkPrintOperationAction;
;;;
;;; The action parameter to gtk_print_operation_run() determines what action the
;;; print operation should perform.
;;;
;;; GTK_PRINT_OPERATION_ACTION_PRINT_DIALOG
