...
;;; };
;;; 
;;; A GtkTargetEntry structure represents a single type of data than can be
...
;;; 
;;; guint info;
;;;     an application-assigned integer ID which will get passed as a parater
...
;;; 
;;; Returns :
;;;     the new GtkTargetList. [transfer full]
;;; ----------------------------------------------------------------------------
...
;;; 
;;; targets :
;;;     the table of GtkTargetEntry. [array length=ntargets]
;;; 
;;; ntargets :
...
;;; 
;;; targets :
;;;     a GtkTargetEntry array. [array length=n_targets]
;;; 
;;; n_targets :
...
;;;                                                  gint *n_targets);
;;; 
;;; This function creates an GtkTargetEntry array that contains the same
;;; targets as the passed list. The returned table is newly allocated and should
;;; be freed using gtk_target_table_free() when no longer needed.
;;; 
;;; list :
;;;     a GtkTargetList
;;; 
;;; n_targets :
;;;     return location for the number ot targets in the table. [out]
;;; 
;;; Returns :
...
;;;                              gint length);
;;; 
;;; Stores new data into a GtkSelectionData object. Should only be called from
;;; a selection handler callback. Zero-terminates the stored data.
;;; 
;;; selection_data :
...
;;;     NULL-terminated string array containing the URIs, otherwise NULL. If
;;;     the result is non-NULL it must be freed with g_strfreev()
;;; 
;;; Since 2.6
;;; ----------------------------------------------------------------------------
...
;;;                                      gboolean writable);
;;; 
;;; Given a GtkSelectionData object holding a list of targets, determines if
;;; any of the targets in targets can be used to provide a GdkPixbuf.
;;; 
;;; selection_data :
;;;     a GtkSelectionData object
;;; 
...
;;; 
;;; Given a GtkSelectionData object holding a list of targets, determines if
;;; any of the targets in targets can be used to provide rich text.
;;; 
;;; selection_data :
;;;     a GtkSelectionData object
;;; 
...
;;; 
;;; Returns :
;;;     the selection GdkAtom of the selection data. [transfer none]
;;; 
;;; Since 2.16
;;; ----------------------------------------------------------------------------
...
;;; 
;;; Returns :
;;;     the data type of the selection. [transfer none]
;;; 
;;; Since 2.14
;;; ----------------------------------------------------------------------------
...
;;; 
;;; Returns :
;;;     the display of the selection. [transfer none]
;;; 
;;; Since 2.14
;;; ----------------------------------------------------------------------------
...
;;; 
;;; Returns :
;;;     the target of the selection. [transfer none]
;;; 
;;; Since 2.14
;;; ----------------------------------------------------------------------------
