...
(test gtk-page-orientation
  ...
  (is (equal '(DEFINE-G-ENUM "GtkPageOrientation"
                              ...
                              (:REVERSE-PORTRAIT 2)
                              (:REVERSE-LANDSCAPE 3))
             (get-g-type-definition "GtkPageOrientation"))))
...
(test gtk-print-duplex
  ...
  (is (equal '(DEFINE-G-ENUM "GtkPrintDuplex"
                             ...
                             (:HORIZONTAL 1)
                             (:VERTICAL 2))
             (get-g-type-definition "GtkPrintDuplex"))))
...
(test gtk-print-quality
  ...
  (is (equal '(DEFINE-G-ENUM "GtkPrintQuality"
                             ...
                             (:HIGH 2)
                             (:DRAFT 3))
             (get-g-type-definition "GtkPrintQuality"))))
...
(test gtk-print-number-up-layout
  ...
  (is (eq 'gtk-number-up-layout
          (registered-enum-type "GtkNumberUpLayout")))
  ;; Check the names
  (is (equal '("GTK_NUMBER_UP_LAYOUT_LEFT_TO_RIGHT_TOP_TO_BOTTOM"
             ...
             (mapcar #'enum-item-name
                     (get-enum-items "GtkNumberUpLayout"))))
  ;; Check the values
  ...
  (is (equal '(DEFINE-G-ENUM "GtkNumberUpLayout"
                             ...
                             (:BTLR 6)
                             (:BTRL 7))
             (get-g-type-definition "GtkNumberUpLayout"))))
...
(test gtk-print-pages
  ...
  (is (equal '(DEFINE-G-ENUM "GtkPrintPages"
                             ...
                             (:RANGES 2)
                             (:SELECTION 3))
             (get-g-type-definition "GtkPrintPages"))))
...
(test gtk-page-set
  ...
  (is (equal '(DEFINE-G-ENUM "GtkPageSet"
                             ...
                             (:EVEN 1)
                             (:ODD 2))
             (get-g-type-definition "GtkPageSet"))))
...
(test gtk-print-settings-file
  (let ((settings (gtk-print-settings-new-from-file "rtest-gtk-print-settings.ini")))
    ...
    (is (typep (gtk-print-settings-new-from-file "rtest-gtk-print-settings.ini")
               'gtk-print-settings))))
