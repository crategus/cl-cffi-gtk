...
(test gtk-builder-new
  ...
  (let ((builder (make-instance 'gtk-builder :from-string *dialog*)))
    (is (eq 'gtk-dialog (type-of (gtk-builder-get-object builder "dialog1")))))
  (let ((builder (make-instance 'gtk-builder 
                                :from-file "rtest-application.ui")))
    (is (eq 'g-menu (type-of (gtk-builder-get-object builder "menubar"))))))
...
(test gtk-builder-get-object
  (let ((builder (gtk-builder-new-from-string *dialog*)))
    (is (eq 'gtk-dialog (type-of (gtk-builder-get-object builder "dialog1"))))
    (is (eq 'gtk-button (type-of (gtk-builder-get-object builder "ok_button"))))))

;;; --- gtk-builder-get-objects ------------------------------------------------

(test gtk-builder-get-objects
  (let ((builder (gtk-builder-new)))
    (is (eq 'gtk-builder (type-of builder)))
    (is (equal '() (gtk-builder-get-objects builder)))
    (is-true (gtk-builder-add-from-string builder *menus*))
