...
(test get-enum-items
  (is (equal '("GDK_DRAG_PROTO_NONE" "GDK_DRAG_PROTO_MOTIF" "GDK_DRAG_PROTO_XDND"
 "GDK_DRAG_PROTO_ROOTWIN" "GDK_DRAG_PROTO_WIN32_DROPFILES"
 "GDK_DRAG_PROTO_OLE2" "GDK_DRAG_PROTO_LOCAL" "GDK_DRAG_PROTO_WAYLAND")
             (mapcar #'gobject::enum-item-name
                     (gobject::get-enum-items "GdkDragProtocol"))))
  (is (equal '(0 1 2 3 4 5 6 7)
             (mapcar #'gobject::enum-item-value
                     (gobject::get-enum-items "GdkDragProtocol"))))
  (is (equal '("none" "motif" "xdnd" "rootwin" "win32-dropfiles" "ole2" "local" "wayland")
