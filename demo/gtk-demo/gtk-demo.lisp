    ...
    (flet ((demo (parent index title &optional (filename #P"") function)
      ...
      (let ((root (tree-lisp-store-root model)))
        ...
        (let ((parent (demo root 8 "Selectors (Color/File/Font)")))
          ...
          (demo parent 5 "Places Sidebar" "places-sidebar.lisp" 'example-places-sidebar))
        (let ((parent (demo root 9 "Layout Containers")))
          ...
          (demo parent 13 "Flow Box" "flow-box.lisp" 'example-flow-box)
          (demo parent 14 "List Box" "list-box.lisp" 'example-list-box)
          (demo parent 15 "Revealer" "revealer.lisp" 'example-revealer)
          (demo parent 16 "Stack" "stack.lisp" 'example-stack))
